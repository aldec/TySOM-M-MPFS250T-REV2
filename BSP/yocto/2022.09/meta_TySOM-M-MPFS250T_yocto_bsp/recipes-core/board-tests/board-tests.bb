...
do_install () {
    ...
    install -m 0744 ${WORKDIR}/FMC_Industrial_Pmod.sh ${D}/root
    install -m 0744 ${WORKDIR}/FMC_Industrial_RS485A-to-RS485B.sh ${D}/root
    install -m 0744 ${WORKDIR}/FMC_Industrial_RS485B-to-RS485A.sh ${D}/root
}
FILES:${PN} += "/root"
