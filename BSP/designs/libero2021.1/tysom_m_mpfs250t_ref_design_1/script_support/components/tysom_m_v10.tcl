...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:FIC_0_AXI4_MASTER}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:FIC_3_APB_MASTER}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EMMC_CLK" "Aldec_MSSv2_0:EMMC_CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EMMC_DATA2" "Aldec_MSSv2_0:EMMC_DATA2" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"EMMC_DATA3" "Aldec_MSSv2_0:EMMC_DATA3" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"EMMC_RSTN" "Aldec_MSSv2_0:EMMC_RSTN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:CLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "Aldec_MSSv2_0:FIC_0_ACLK" "Aldec_MSSv2_0:FIC_3_PCLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:FABRIC_RESET_N" "VSC_8662_RESETN" "USB_ULPI_RESET" "Aldec_MSSv2_0:MSS_RESET_N_F2M" }
...
#sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:CAN_1_TXBUS_M2F}
