...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:MMUART_4_TXD_M2F}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:CAN_0_TX_EBL_M2F}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:CAN_1_TX_EBL_M2F}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"BIBUF_0:E" "Aldec_MSSv2_0:I2C_0_SCL_OE_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BIBUF_1:E" "Aldec_MSSv2_0:I2C_0_SDA_OE_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"BIBUF_0:Y" "Aldec_MSSv2_0:I2C_0_SCL_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:I2C_0_SDA_F2M" "BIBUF_1:Y" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAN_1_RXBUS_F2M" "Aldec_MSSv2_0:CAN_1_RXBUS_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CAN_1_TXBUS_M2F" "Aldec_MSSv2_0:CAN_1_TXBUS_M2F" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:EMMC_CMD" "EMMC_CMD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:EMMC_DATA0" "EMMC_DATA0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"GATE_0:PCLK" "COREAXI4INTERCONNECT_C0_0:ACLK" "RS485_0:PCLK" "CORERESET_PF_C0_0:CLK" "Aldec_MSSv2_0:FIC_0_ACLK" "PMOD_0:PCLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "Aldec_MSSv2_0:FIC_3_PCLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RS485A_RXD" "Aldec_MSSv2_0:MMUART_3_RXD_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"RS485A_TXD" "Aldec_MSSv2_0:MMUART_3_TXD_M2F" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:SPI_1_SS0" "SPI_1_SS0" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RS485_0:PRESETN" "USB_ULPI_RESET" "PF_DDR4_C0_0:SYS_RESET_N" "VSC_8662_RESETN" "CORERESET_PF_C0_0:FABRIC_RESET_N" "PMOD_0:PRESETN" "COREAXI4INTERCONNECT_C0_0:ARESETN" "GATE_0:PRESETN" "Aldec_MSSv2_0:MSS_RESET_N_F2M" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:FIC_3_APB_MASTER" "CoreAPB3_C0_0:APB3mmaster" }
