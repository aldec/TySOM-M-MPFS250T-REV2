...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:MMUART_3_RXD_F2M} -value {GND}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:CAN_0_RXBUS_F2M" "CAN_0_RXBUS_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSSv2_0:CAN_0_TXBUS_M2F" "CAN_0_TXBUS_M2F" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"EMMC_STRB" "Aldec_MSSv2_0:EMMC_STRB" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:CLK" "LANE_0:PCLK" "COREAXI4INTERCONNECT_C0_0:ACLK" "LINE_1:PCLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "Aldec_MSSv2_0:FIC_3_PCLK" "Aldec_MSSv2_0:FIC_0_ACLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE_0:PRESETN" "CORERESET_PF_C0_0:FABRIC_RESET_N" "COREAXI4INTERCONNECT_C0_0:ARESETN" "LINE_1:PRESETN" "PF_DDR4_C0_0:SYS_RESET_N" "Aldec_MSSv2_0:MSS_RESET_N_F2M" "USB_ULPI_RESET" "VSC_8662_RESETN" }
...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:MMUART_3_TXD_M2F}
...
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {Aldec_MSSv2_0:CAN_1_IN} -value {GND}
