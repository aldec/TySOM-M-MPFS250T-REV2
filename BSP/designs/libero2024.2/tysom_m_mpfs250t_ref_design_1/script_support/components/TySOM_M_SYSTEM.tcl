...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:FIC_0_ACLK" "Aldec_MSS_2024_9:FIC_3_PCLK" "CORERESET_PF_C0_0:CLK" "PF_CCC_C0_0:OUT3_FABCLK_0" "fabric_sd_emmc_demux_select_0:pclk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MSS_RESET_N_F2M" "CORERESET_PF_C0_0:FABRIC_RESET_N" "USB_ULPI_RESET" "VSC_8662_RESETN" "fabric_sd_emmc_demux_select_0:presetn" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"APB_ARBITER_0:APB_MMASTER" "Aldec_MSS_2024_9:FIC_3_APB_INITIATOR" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"APB_PASS_THROUGH_0:APB_INITIATOR" "FIC_3_0x4FFF_Fxxx_0:APB3mmaster" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"APB_PASS_THROUGH_0:APB_TARGET" "FIC_3_0x4xxx_xxxx_0:APBmslave15" }
