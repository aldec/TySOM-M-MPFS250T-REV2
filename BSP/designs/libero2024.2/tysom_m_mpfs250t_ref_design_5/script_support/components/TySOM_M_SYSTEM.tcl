...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:CAN_1_RXBUS_F2M" "CAN_1_RXBUS_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:CAN_1_TXBUS_M2F" "CAN_1_TXBUS_M2F" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:FIC_0_ACLK" "Aldec_MSS_2024_9:FIC_3_PCLK" "COREAXI4INTERCONNECT_C0_0:ACLK" "CORERESET_PF_C0_0:CLK" "GATE_0:PCLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "PMOD_0:PCLK" "RS485_0:PCLK" "fabric_sd_emmc_demux_select_0:pclk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MMUART_3_RXD_F2M" "RS485A_RXD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MMUART_3_TXD_M2F" "RS485A_TXD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MMUART_4_RXD_F2M" "Aldec_MSS_2024_9:MMUART_4_TXD_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MSS_RESET_N_F2M" "COREAXI4INTERCONNECT_C0_0:ARESETN" "CORERESET_PF_C0_0:FABRIC_RESET_N" "GATE_0:PRESETN" "PF_DDR4_C0_0:SYS_RESET_N" "PMOD_0:PRESETN" "RS485_0:PRESETN" "USB_ULPI_RESET" "VSC_8662_RESETN" "fabric_sd_emmc_demux_select_0:presetn" }
