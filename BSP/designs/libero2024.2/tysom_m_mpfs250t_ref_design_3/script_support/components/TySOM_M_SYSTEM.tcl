...
sd_instantiate_component -sd_name ${sd_name} -component_name {TySOM_M_PCIe_2024_9} -instance_name {ALDEC_MSS_2024_9}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[0:0]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[0:0]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[1:1]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[2:2]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[2:2]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[3:3]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[3:3]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[4:58]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[4:58]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[59:59]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[59:59]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[60:60]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[60:60]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[61:61]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[61:61]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[62:62]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[62:62]} -value {GND}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {ALDEC_MSS_2024_9:MSS_INT_F2M} -pin_slices {[63:63]}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:MSS_INT_F2M[63:63]} -value {GND}
sd_connect_pins_to_constant -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:CAN_0_RXBUS_F2M} -value {GND}
...
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:CAN_0_TXBUS_M2F}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:CAN_1_TX_EBL_M2F}
sd_mark_pins_unused -sd_name ${sd_name} -pin_names {ALDEC_MSS_2024_9:CAN_1_TXBUS_M2F}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_0_ACLK" "CLOCKS_AND_RESETS:FIC_0_CLK" "PF_DDR4_C0_0:PLL_REF_CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_0_DLL_LOCK_M2F" "AND4_MSS_DLL_LOCKS:A" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_1_ACLK" "CLOCKS_AND_RESETS:FIC_1_CLK" "FIC_1_PERIPHERALS_1:ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_1_DLL_LOCK_M2F" "AND4_MSS_DLL_LOCKS:B" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_2_ACLK" "CLOCKS_AND_RESETS:FIC_2_CLK" "DDR4_INITIATOR_0:ACLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_2_DLL_LOCK_M2F" "AND4_MSS_DLL_LOCKS:C" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_3_DLL_LOCK_M2F" "AND4_MSS_DLL_LOCKS:D" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_3_PCLK" "CLOCKS_AND_RESETS:FIC_3_CLK" "FIC_1_PERIPHERALS_1:PCLK" "FIC_3_PERIPHERALS_1:PCLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:I2C_0_SCL_F2M" "BIBUF_I2C0_SCL:Y" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:I2C_0_SCL_OE_M2F" "BIBUF_I2C0_SCL:E" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:I2C_0_SDA_F2M" "BIBUF_I2C0_SDA:Y" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:I2C_0_SDA_OE_M2F" "BIBUF_I2C0_SDA:E" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MMUART_3_RXD_F2M" "MMUART_3_RXD_F2M" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MMUART_3_TXD_M2F" "MMUART_3_TXD_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MMUART_4_RXD_F2M" "ALDEC_MSS_2024_9:MMUART_4_TXD_M2F" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MSS_INT_F2M[1:1]" "FIC_1_PERIPHERALS_1:PCIe_IRQ" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MSS_RESET_N_F2M" "CLOCKS_AND_RESETS:RESETN_FIC_0_CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:MSS_RESET_N_M2F" "CLOCKS_AND_RESETS:EXT_RST_N" "DDR4_INITIATOR_0:ARESETN" "PF_DDR4_C0_0:SYS_RESET_N" "USB_ULPI_RESET" "VSC_8662_RESETN" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_3_APB_M_PSTRB" "FIC_3_PERIPHERALS_1:PSTRB" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_0_AXI4_INITIATOR" "DDR4_INITIATOR_0:AXI4mmaster0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_1_AXI4_INITIATOR" "FIC_1_PERIPHERALS_1:AXI4mmaster0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_1_AXI4_TARGET" "FIC_1_PERIPHERALS_1:AXI4mslave0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"ALDEC_MSS_2024_9:FIC_3_APB_INITIATOR" "FIC_3_PERIPHERALS_1:APB_MMASTER" }
