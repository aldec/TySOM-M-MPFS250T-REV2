...
download_core -vlnv {Actel:SgCore:PF_PCIE:2.0.121} -location {www.microchip-ip.com/repositories/SgCore}
...
import_files \
         ...
         -io_pdc "${constraint_path}/ALDEC_io.pdc" \
		 -io_pdc "${constraint_path}/ALDEC_DDR4.pdc" \
		 
organize_tool_files -tool {PLACEROUTE}  -file "${project_dir}/constraint/io/ALDEC_io.pdc" -file "${project_dir}/constraint/io/ALDEC_DDR4.pdc" -module {TySOM_M_SYSTEM::work} -input_type {constraint}		 
