...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:FIC_0_ACLK" "Aldec_MSS_2024_9:FIC_3_PCLK" "COREAXI4INTERCONNECT_C0_0:ACLK" "CORERESET_PF_C0_0:CLK" "CoreGPIO_C0_0:PCLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "fabric_sd_emmc_demux_select_0:pclk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:MSS_RESET_N_F2M" "COREAXI4INTERCONNECT_C0_0:ARESETN" "CORERESET_PF_C0_0:FABRIC_RESET_N" "CoreGPIO_C0_0:PRESETN" "PF_DDR4_C0_0:SYS_RESET_N" "USB_ULPI_RESET" "VSC_8662_RESETN" "fabric_sd_emmc_demux_select_0:presetn" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_CD_EMMC_STRB" "SD_CD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_CLK_EMMC_CLK" "SD_CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_CMD_EMMC_CMD" "SD_CMD" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_DATA0_EMMC_DATA0" "SD_DATA0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_DATA1_EMMC_DATA1" "SD_DATA1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_DATA2_EMMC_DATA2" "SD_DATA2" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_DATA3_EMMC_DATA3" "SD_DATA3" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_VOLT_DIR_0_EMMC_UNUSED" "SD_VOLT_DIR_0" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_VOLT_DIR_1_3_EMMC_UNUSED" "SD_VOLT_DIR_1_3" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2024_9:SD_WP_EMMC_RSTN" "SD_WP" }
