...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CLK_125" "COREUART_C0_0:CLK" "FabUART_0:clk" "Reset_Synchronizer_0:clk_i" "UART_IF_CLK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"RESET" "Reset_Synchronizer_0:lock_i" "Reset_Synchronizer_0:reset_n_i" }

# Add bus net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREUART_C0_0:DATA_IN" "FabUART_0:uart_data_out" }
