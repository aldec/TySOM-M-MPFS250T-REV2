...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2022_2:FIC_0_ACLK" "Aldec_MSS_2022_2:FIC_3_PCLK" "COREAXI4INTERCONNECT_C0_0:ACLK" "CORERESET_PF_C0_0:CLK" "LANE_0:PCLK" "LINE_1:PCLK" "PF_CCC_C0_0:OUT0_FABCLK_0" "fabric_sd_emmc_demux_select_0:pclk" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"Aldec_MSS_2022_2:MSS_RESET_N_F2M" "COREAXI4INTERCONNECT_C0_0:ARESETN" "CORERESET_PF_C0_0:FABRIC_RESET_N" "LANE_0:PRESETN" "LINE_1:PRESETN" "PF_DDR4_C0_0:SYS_RESET_N" "USB_ULPI_RESET" "VSC_8662_RESETN" "fabric_sd_emmc_demux_select_0:presetn" }
