...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[0:0]" "DATA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[1:1]" "DATA_1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[2:2]" "DATA_0" }
