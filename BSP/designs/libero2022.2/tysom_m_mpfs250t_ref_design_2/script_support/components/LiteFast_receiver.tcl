...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:DATA} -pin_slices {[32:32]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:DATA} -pin_slices {[33:33]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:DATA} -pin_slices {[34:34]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:DATA} -pin_slices {[35:35]}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:Q} -pin_slices {[32:32]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:Q} -pin_slices {[33:33]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:Q} -pin_slices {[34:34]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C3_0:Q} -pin_slices {[35:35]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:DATA[32:32]" "Count_Checker_0:crc_error_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:DATA[33:33]" "Count_Checker_0:error_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:DATA[34:34]" "Count_Checker_0:lock_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:DATA[35:35]" "Count_Checker_0:rx_val_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:Q[32:32]" "crc_error_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:Q[33:33]" "error_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:Q[34:34]" "lock_o" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C3_0:Q[35:35]" "rx_val_o" }
