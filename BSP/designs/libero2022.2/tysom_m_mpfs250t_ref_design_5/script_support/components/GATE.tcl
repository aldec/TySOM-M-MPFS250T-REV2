# Exporting Component Description of GATE to TCL
# Family: PolarFireSoC
# Part Number: MPFS250T_ES-1FCG1152E
# Create and Configure the core component GATE
create_and_configure_core -core_vlnv {Actel:DirectCore:CoreGPIO:3.2.102} -component_name {GATE} -params {\
"APB_WIDTH:32"  \
...
"IO_VAL_31:0"  \
"OE_TYPE:0"   }
# Exporting Component Description of GATE to TCL done
