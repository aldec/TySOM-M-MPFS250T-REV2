# Exporting Component Description of DDR4_INITIATOR to TCL
# Family: PolarFireSoC
# Part Number: MPFS250T_ES-FCG1152E
# Create and Configure the core component DDR4_INITIATOR
create_and_configure_core -core_vlnv {Actel:DirectCore:COREAXI4INTERCONNECT:2.8.103} -component_name {DDR4_INITIATOR} -params {\
"ADDR_WIDTH:32"  \
"CROSSBAR_MODE:0"  \
"DATA_WIDTH:64"  \
...
"USER_WIDTH:1"   }
# Exporting Component Description of DDR4_INITIATOR to TCL done
