...
organize_tool_files -tool {PLACEROUTE}  -file "${project_dir}/constraint/io/ALDEC_io.pdc" -file "${project_dir}/constraint/io/ALDEC_DDR4.pdc" -module {tysom_m_2022_2::work} -input_type {constraint}		 
