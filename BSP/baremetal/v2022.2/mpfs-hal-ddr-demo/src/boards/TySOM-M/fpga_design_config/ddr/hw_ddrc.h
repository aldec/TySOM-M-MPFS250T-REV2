...
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_TEMP_CTRL_REF_MODE    0x00000001UL
    /* CFG_TEMP_CTRL_REF_MODE            [0:32]  RW value= 0x1 */
#endif
...
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_DATA_MASK    0x00000000UL
    /* CFG_DATA_MASK                     [0:32]  RW value= 0x0 */
#endif
...
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_WTR_S_CRC_DM    0x00000008UL
    /* CFG_WTR_S_CRC_DM                  [0:32]  RW value= 0x8 */
#endif
...
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_WR_CRC_DM    0x0000000FUL
    /* CFG_WR_CRC_DM                     [0:32]  RW value= 0xF */
#endif
#if !defined (LIBERO_SETTING_CFG_RFC1)
/*IP Blk = MC_BASE1 Access=RW */
#define LIBERO_SETTING_CFG_RFC1    0x000000EAUL
    /* CFG_RFC1                          [0:32]  RW value= 0xEA */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RAS    0x00000018UL
    /* CFG_RAS                           [0:32]  RW value= 0x18 */
#endif
#if !defined (LIBERO_SETTING_CFG_RCD)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RCD    0x0000000AUL
    /* CFG_RCD                           [0:32]  RW value= 0xA */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RP    0x0000000AUL
    /* CFG_RP                            [0:32]  RW value= 0xA */
#endif
#if !defined (LIBERO_SETTING_CFG_RC)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RC    0x00000021UL
    /* CFG_RC                            [0:32]  RW value= 0x21 */
#endif
#if !defined (LIBERO_SETTING_CFG_FAW)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_FAW    0x00000011UL
    /* CFG_FAW                           [0:32]  RW value= 0x11 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RTP    0x00000005UL
    /* CFG_RTP                           [0:32]  RW value= 0x5 */
#endif
#if !defined (LIBERO_SETTING_CFG_WR)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_WR    0x0000000AUL
    /* CFG_WR                            [0:32]  RW value= 0xA */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_RTT    0x00000000UL
    /* CFG_RTT                           [0:32]  RW value= 0x0 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_REF_PER    0x0000144BUL
    /* CFG_REF_PER                       [0:32]  RW value= 0x144B */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_MEM_ROWBITS    0x0000000FUL
    /* CFG_MEM_ROWBITS                   [0:32]  RW value= 0xF */
#endif
#if !defined (LIBERO_SETTING_CFG_MEM_BANKBITS)
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_MEM_BANKBITS    0x00000004UL
    /* CFG_MEM_BANKBITS                  [0:32]  RW value= 0x4 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_XS    0x000000F0UL
    /* CFG_XS                            [0:32]  RW value= 0xF0 */
#endif
...
/*IP Blk = MC_BASE2 Access=RW */
#define LIBERO_SETTING_CFG_XPR    0x000000F0UL
    /* CFG_XPR                           [0:32]  RW value= 0xF0 */
#endif
