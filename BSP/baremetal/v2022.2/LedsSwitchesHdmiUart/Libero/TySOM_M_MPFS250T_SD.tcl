...
source ./script_support/tysom_m_2022_2_SD_recursive.tcl
...
import_files \
         ...
         -io_pdc "${constraint_path}/ALDEC_SWITCHES.pdc" \
         -io_pdc "${constraint_path}/ALDEC_HDMI.pdc" \
         -io_pdc "${constraint_path}/ALDEC_LED.pdc" 
		 
organize_tool_files -tool {PLACEROUTE} -file "${project_dir}/constraint/io/ALDEC_CAN0.pdc" -file "${project_dir}/constraint/io/ALDEC_SDIO.pdc" -file "${project_dir}/constraint/io/ALDEC_USB.pdc" -file "${project_dir}/constraint/io/ALDEC_MAC.pdc" -file "${project_dir}/constraint/io/ALDEC_UARTs.pdc" -file "${project_dir}/constraint/io/ALDEC_SWITCHES.pdc" -file "${project_dir}/constraint/io/ALDEC_HDMI.pdc" -file "${project_dir}/constraint/io/ALDEC_LED.pdc" -module {tysom_m_2022_2_SD::work} -input_type {constraint} 
