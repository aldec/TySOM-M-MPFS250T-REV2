...
sd_create_scalar_port -sd_name ${sd_name} -port_name {payload_error_tx_i} -port_direction {IN}
...
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:DATA} -pin_slices {[0:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:DATA} -pin_slices {[1:1]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:DATA} -pin_slices {[2:2]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:Q} -pin_slices {[0:0]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:Q} -pin_slices {[1:1]}
sd_create_pin_slices -sd_name ${sd_name} -pin_name {COREFIFO_C0_0:Q} -pin_slices {[2:2]}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[0:0]" "start_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[1:1]" "crc_error_tx_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:DATA[2:2]" "payload_error_tx_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:EMPTY" "INV_0_0:A" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:FULL" "INV_0:A" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:Q[0:0]" "Counter_0:start_i" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:RCLOCK" "Counter_0:clk_i" "LiteFast_C2_0:clk_tx_i" "clk_tx_i" "synchronizer_0:clk_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:RE" "INV_0_0:Y" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:RRESET_N" "COREFIFO_C0_0:WRESET_N" "Counter_0:reset_n_i" "LiteFast_C2_0:rst_n_tx_i" "reset_n_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:WCLOCK" "clk_125_i" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"COREFIFO_C0_0:WE" "INV_0:Y" }
