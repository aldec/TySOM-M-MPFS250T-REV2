...
sd_create_pin_group -sd_name ${sd_name} -group_name {PADs_IN} -instance_name {top_0} -pin_names {"LANE0_RXD_N" "LANE3_RXD_N" "LANE3_RXD_P" "LANE2_RXD_N" "LANE2_RXD_P" "LANE1_RXD_P" "LANE1_RXD_N" "LANE0_RXD_P" }
sd_create_pin_group -sd_name ${sd_name} -group_name {PADs_OUT} -instance_name {top_0} -pin_names {"LANE3_TXD_P" "LANE0_TXD_N" "LANE0_TXD_P" "LANE1_TXD_N" "LANE1_TXD_P" "LANE2_TXD_P" "LANE2_TXD_N" "LANE3_TXD_N" }
sd_create_pin_group -sd_name ${sd_name} -group_name {PMA_ARST_N} -instance_name {top_0} -pin_names {"LANE0_PMA_ARST_N" "LANE1_PMA_ARST_N" "LANE2_PMA_ARST_N" "LANE3_PMA_ARST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESET_PF_C0_0:INIT_DONE" "PFSOC_INIT_MONITOR_C0_0:DEVICE_INIT_DONE" "top_0:LANE0_PMA_ARST_N" "top_0:LANE1_PMA_ARST_N" "top_0:LANE2_PMA_ARST_N" "top_0:LANE3_PMA_ARST_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_RXD_N" "top_0:LANE2_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_RXD_P" "top_0:LANE2_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_TXD_N" "top_0:LANE2_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE2_TXD_P" "top_0:LANE2_TXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_RXD_N" "top_0:LANE3_RXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_RXD_P" "top_0:LANE3_RXD_P" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_TXD_N" "top_0:LANE3_TXD_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"LANE3_TXD_P" "top_0:LANE3_TXD_P" }
