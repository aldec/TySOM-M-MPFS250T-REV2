...
The reference design includes the MSS Configurator source file **TySOM_M_2024_9.cfg**
and the software configuration output file **TySOM_M_2024_9_mss_cfg.xml**
...
## TySOM-M Build Configuration selection:
...
Configuration for your board using Libero and MSS configurator tool and the **TySOM_M_2024_9.cfg**
and **TySOM_M_2024_9_mss_cfg.xml** from this new design are available.

### Add new board under the boards directory

Create a new directory /\<my_board> under the src/boards directory. Use TySOM_M_2024_9_mss_cfg as a template, copying and renaming as appropriate.
  * src/boards/**\<my-board>**
...
MSS Configurator **v2024.2**. If you are presently using a MSS configuration
...
1. Open your current MSS configuration in the MSS Configurator **v2024.2**.
...
configurations from the latest MSS configuration (2024.2 and later), as updated
...
Configurator (2024.2 and later) and **avoid any DDR settings overwrites**.
